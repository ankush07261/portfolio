...
import da from "../assets/images/MyWork-SS/da.png";
import ftd from "../assets/images/MyWork-SS/ftd.png";
...
export const programming = [
  ...
  },
  {
    ...
    description: "Detects illegal transactions using the Isolation Forest model.",
    gitURL:"https://github.com/ankush07261/AI_Fraud_Transaction_Detection",
    concepts: ["Python", "SciKit-Learn", "Isolation Forest"],
  },
  {
    image: File_Cache,
  ...
  {
    image: da,
    title: "Stack Overflow survey Data Analysis",
    description: "Analyzed the Stack Overflow survey data using Python.",
    gitURL:"https://github.com/ankush07261/Stack_Overflow_EDA",
    concepts: ["Python", "Data Analysis & Visulization"],
  },
  {
    image: DBMS,
